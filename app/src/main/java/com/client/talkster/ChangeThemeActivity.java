...
public class ChangeThemeActivity extends AppCompatActivity  implements IActivity, IThemeManagerActivityListener {
    ...
    private ConstraintLayout changeThemeLayout;
    ...
    public void getUIElements()
    {
        ...
        themeAdapter = new ThemeListAdapter(this, new IRecyclerViewItemClickListener()
        {
            ...
            public void onItemClick(int position, View v)
            {
                ...
                int w = changeThemeLayout.getMeasuredWidth();
                int h = changeThemeLayout.getMeasuredHeight();
                ...
                changeThemeLayout.draw(canvas);
                themeTransitionImage.setImageBitmap(bitmap);
                themeTransitionImage.setVisibility(View.VISIBLE);

                ThemeManager.applyTheme(ChangeThemeActivity.this, themeAdapter.getThemeList().get(position));
    ...
    public void onThemeChanged()
    {
        ...
        changeThemeLayout.setBackgroundColor(ThemeManager.getColor("windowBackgroundGray"));
